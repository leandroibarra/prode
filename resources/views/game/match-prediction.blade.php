    ...
    <div class="col-10">
        ...
        <form method="POST" action="{{ route('match-prediction.update') }}">
            ...
            <div class="form-group row mb-0">
                <div class="col-3 col-md-5 text-right my-auto">
                ...
                <div class="col-6 col-md-5 text-left my-auto">{{ $aMatchSchedule['home_team']['name'] }}</div>
            </div>
            ...
            <div class="form-group row mb-0">
                ...
                <div class="col-6 col-md-5 text-left my-auto">{{ $aMatchSchedule['away_team']['name'] }}</div>
            </div>
